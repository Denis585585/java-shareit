...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<Object> addBooking(@RequestHeader(name = SHARER_USER_ID) Long userId,
    ...
    public ResponseEntity<Object> patchBooking(@RequestHeader(name = SHARER_USER_ID) Long userId,
    ...
    @GetMapping
    public ResponseEntity<Object> getBookingsByBooker(@RequestHeader(name = SHARER_USER_ID) Long bookerId,
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getBookingsByOwner(@RequestHeader(name = SHARER_USER_ID) Long userId,
                                                     @RequestParam(name = "state", defaultValue = "ALL") String stateParam,
                                                     @PositiveOrZero @RequestParam(name = "from", defaultValue = "0") int from,
                                                     @Positive @RequestParam(name = "size", defaultValue = "10") int size) {
    ...
    public ResponseEntity<Object> getBookingByBookerOrOwnerItem(@RequestHeader(name = SHARER_USER_ID) Long userId,
                                                                @PathVariable Long bookingId) {
